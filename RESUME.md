...
**Revision:** 7
**Created:** 2026-07-08
**Last modified:** 2026-07-28T18:20Z (doc-refresh pass, §11.4.131/§12.10)
**Status:** active
...
|-----|-------|--------------|
| **Meta-repo HEAD** | ⚠️ **rev 6 row superseded — re-derived rev 7 (2026-07-28T18:20Z, doc-refresh pass):** `99ff7d8e` (branch `main`) — **20 commits ahead** of ALL 4 configured remotes (github/gitlab/origin/upstream), 0 behind (was `c29e1dcc`/8-ahead at rev 6, 12 more commits landed since — see the Revision 7 blockquote at the top of this file for what they contain, incl. a self-inflicted-and-fixed compile break at `3fd55a4d`→`34e264e1`). VOLATILE — this repo has moved every single time it has been checked this session; re-derive again | `git rev-parse HEAD`; `git fetch --all --prune --tags` then `git rev-list --left-right --count main...refs/remotes/<r>/main` per remote |
...
**NEW this revision (rev 7, 2026-07-28T18:20Z — found while re-deriving live state, not fixed in this pass, doc-only scope):**
...
1. Independent review (§11.4.142) of the llamacpp fix + its RED test — **NOT VERIFIED.** No review artefact located this revision. Treat as outstanding; re-dispatch. Re-checked rev 7 (2026-07-28T18:20Z): still no matching artefact found under `docs/qa/`; unchanged.
