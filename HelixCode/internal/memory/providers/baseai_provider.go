...
func (p *BaseAIProvider) Store(ctx context.Context, data []*memory.VectorData) error {
	if len(data) == 0 {
		return nil
	}
...
func (p *BaseAIProvider) Search(ctx context.Context, query *memory.VectorQuery) (*memory.VectorSearchResult, error) {
...
func (p *BaseAIProvider) Retrieve(ctx context.Context, ids []string) ([]*memory.VectorData, error) {
...
func (p *BaseAIProvider) Update(ctx context.Context, id string, vector *memory.VectorData) error {
...
func (p *BaseAIProvider) CreateCollection(ctx context.Context, name string, config *memory.CollectionConfig) error {
...
func (p *BaseAIProvider) ListCollections(ctx context.Context) ([]*memory.CollectionInfo, error) {
...
func (p *BaseAIProvider) GetCollection(ctx context.Context, name string) (*memory.CollectionInfo, error) {
	// BaseAI doesn't have explicit collections, this is a stub
...
func (p *BaseAIProvider) CreateIndex(ctx context.Context, collection string, config *memory.IndexConfig) error {
...
func (p *BaseAIProvider) ListIndexes(ctx context.Context, collection string) ([]*memory.IndexInfo, error) {
...
func (p *BaseAIProvider) GetStats(ctx context.Context) (*memory.ProviderStats, error) {
...
func (p *BaseAIProvider) Health(ctx context.Context) (*memory.HealthStatus, error) {
