...
func (p *MemontoProvider) Store(ctx context.Context, data []*memory.VectorData) error {
	if len(data) == 0 {
		return nil
	}
...
func (p *MemontoProvider) Search(ctx context.Context, query *memory.VectorQuery) (*memory.VectorSearchResult, error) {
...
func (p *MemontoProvider) Retrieve(ctx context.Context, ids []string) ([]*memory.VectorData, error) {
...
func (p *MemontoProvider) Update(ctx context.Context, id string, vector *memory.VectorData) error {
...
func (p *MemontoProvider) CreateCollection(ctx context.Context, name string, config *memory.CollectionConfig) error {
...
func (p *MemontoProvider) ListCollections(ctx context.Context) ([]*memory.CollectionInfo, error) {
...
func (p *MemontoProvider) GetCollection(ctx context.Context, name string) (*memory.CollectionInfo, error) {
	// Memonto doesn't have explicit collections, this is a stub
...
func (p *MemontoProvider) CreateIndex(ctx context.Context, collection string, config *memory.IndexConfig) error {
...
func (p *MemontoProvider) ListIndexes(ctx context.Context, collection string) ([]*memory.IndexInfo, error) {
...
func (p *MemontoProvider) GetStats(ctx context.Context) (*memory.ProviderStats, error) {
...
func (p *MemontoProvider) Health(ctx context.Context) (*memory.HealthStatus, error) {
	// Simple health check
