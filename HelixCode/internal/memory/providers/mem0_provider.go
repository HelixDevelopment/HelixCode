...
func (p *Mem0Provider) Store(ctx context.Context, data []*memory.VectorData) error {
	if len(data) == 0 {
		return nil
	}
...
func (p *Mem0Provider) Search(ctx context.Context, query *memory.VectorQuery) (*memory.VectorSearchResult, error) {
...
func (p *Mem0Provider) Health(ctx context.Context) (*memory.HealthStatus, error) {
	var response map[string]interface{}
...
func (p *Mem0Provider) Retrieve(ctx context.Context, ids []string) ([]*memory.VectorData, error) {
	// Mem0 doesn't have direct retrieval by ID, this is a stub
	return []*memory.VectorData{}, nil
}

// Update updates a vector
func (p *Mem0Provider) Update(ctx context.Context, id string, vector *memory.VectorData) error {
...
func (p *Mem0Provider) CreateCollection(ctx context.Context, name string, config *memory.CollectionConfig) error {
...
func (p *Mem0Provider) ListCollections(ctx context.Context) ([]*memory.CollectionInfo, error) {
	// Stub
	return []*memory.CollectionInfo{}, nil
}

// GetCollection gets collection information
func (p *Mem0Provider) GetCollection(ctx context.Context, name string) (*memory.CollectionInfo, error) {
	// Stub
	return nil, fmt.Errorf("collection not found")
}

// CreateIndex creates an index
func (p *Mem0Provider) CreateIndex(ctx context.Context, collection string, config *memory.IndexConfig) error {
	// Stub
	return nil
}
...
func (p *Mem0Provider) ListIndexes(ctx context.Context, collection string) ([]*memory.IndexInfo, error) {
	// Stub
